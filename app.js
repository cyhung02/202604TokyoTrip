...
const itinerary = [
  {
    ...
    date: '3月31日（二）',
    title: '東京初日',
    flow: ['抵達成田機場', '入境領取行李', '購買 Suica/PASMO', '搭車前往東京站', '辦理入住', '東京站周邊覓食'],
    spots: [
      {
        name: '交通建議',
        hours: '',
  ...
  },
  {
    ...
    date: '4月1日（三）',
    title: '千鳥之淵與目黑川夜櫻',
    flow: ['千鳥之淵划船賞櫻', '靖國神社參觀', '九段下午餐', '自由活動', '目黑川夜櫻散策', '晚餐'],
    spots: [
      {
        name: '千鳥之淵',
        hours: '全天開放',
  ...
  },
  {
    ...
    date: '4月2日（四）',
    title: '淺草與上野散策',
    flow: ['隅田公園賞櫻', '晴空塔拍照', '淺草寺與仲見世通', '淺草午餐', '上野公園賞櫻', '阿美橫丁購物與晚餐'],
    spots: [
      {
        name: '隅田公園',
        hours: '全天開放',
  ...
  },
  {
    ...
    date: '4月3日（五）',
    title: '鎌倉江之電與江之島',
    flow: ['小町通散策', '段葛參道與鶴岡八幡宮', '御靈神社', '午餐', '鎌倉大佛', '長谷寺', '鎌倉高校前平交道', '江之島'],
    spots: [
      {
        name: '小町通商店街',
        hours: '',
  ...
  },
  {
    ...
    date: '4月4日（六）',
    title: '箱根溫泉鄉',
    flow: ['退房', '前往新宿', '購買箱根周遊券', '小田急浪漫特快', '箱根湯本', '登山電車與纜車', '大湧谷', '蘆之湖海盜船', '飯店入住與溫泉'],
    spots: [
      {
        name: '箱根登山電車與登山纜車',
        hours: '',
  ...
  },
  {
    ...
    date: '4月5日（日）',
    title: '箱根神社與新宿巡禮',
    flow: ['箱根神社', '箱根湯本商店街', '返回新宿寄放行李', '新宿御苑賞櫻', '明治神宮參拜', '新宿晚餐與購物'],
    spots: [
      {
        name: '箱根神社',
  ...
  },
  {
    ...
    date: '4月6日（一）',
    title: '富士山與河口湖',
    flow: ['退房', '搭乘高速巴士', '富士山站', '新倉富士淺間神社', '午餐', '河口湖飯店寄放行李', '湖畔散策與手作市集', '晚餐', '夜櫻點燈'],
    spots: [
      {
  ...
  },
  {
    ...
    date: '4月7日（二）',
    title: '歸途',
    flow: ['河口湖退房', '周邊散步', '搭乘巴士前往成田機場', '機場購物與用餐', '辦理登機', '返台'],
    spots: [
      {
        name: '河口湖 → 成田機場直達巴士',
        hours: '',
