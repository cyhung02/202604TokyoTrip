    ...
    spots: [
      {
        name: '千鳥之淵',
        hours: '全天開放',
        desc: '皇居外苑西側護城河一帶的賞櫻名所，可租船於水面近距離欣賞櫻花。✅ 已預訂遊船：4 月 1 日 09:30（手划船，2 艘）。請於搭船時間 10 分鐘前（09:20 前）抵達碼頭入口「事前購入者専用 乗船受付（Digital Ticket Reception）」，並非當天票入口。搭船時長 1 小時，不開放再次登船。如遇下雨或強風可能停航，屆時將全額退款。最新碼頭關閉資訊請查詢：https://visit-chiyoda.tokyo/en/sakura/spot/boat.php'
      },
      {
        name: '靖國神社',
